...
import resources.commons.types.IBooleanScore;
...
public final class GetScoresResponseDataBoolean implements IBooleanScore, IBaseScore {
  ...
  private GetScoresResponseDataBoolean(double value, String stringValue, String id, String traceId,
      String name, ScoreSource source, Optional<String> observationId, OffsetDateTime timestamp,
  ...
  public static final class Builder implements ValueStage, StringValueStage, IdStage, TraceIdStage, NameStage, SourceStage, TimestampStage, CreatedAtStage, UpdatedAtStage, TraceStage, _FinalStage {
    ...
    public GetScoresResponseDataBoolean build() {
      return new GetScoresResponseDataBoolean(value, stringValue, id, traceId, name, source, observationId, timestamp, createdAt, updatedAt, authorUserId, comment, configId, queueId, environment, trace, additionalProperties);
    }
  }
}

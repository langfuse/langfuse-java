...
import resources.commons.types.IBaseScore;
import resources.commons.types.ICategoricalScore;
import resources.commons.types.ScoreSource;
...
public final class GetScoresResponseDataCategorical implements ICategoricalScore, IBaseScore {
  ...
  private GetScoresResponseDataCategorical(Optional<Double> value, String stringValue, String id,
      String traceId, String name, ScoreSource source, Optional<String> observationId,
      OffsetDateTime timestamp, OffsetDateTime createdAt, OffsetDateTime updatedAt,
      Optional<String> authorUserId, Optional<String> comment, Optional<String> configId,
      Optional<String> queueId, Optional<String> environment, GetScoresResponseTraceData trace,
  ...
  private boolean equalTo(GetScoresResponseDataCategorical other) {
    return value.equals(other.value) && stringValue.equals(other.stringValue) && id.equals(other.id) && traceId.equals(other.traceId) && name.equals(other.name) && source.equals(other.source) && observationId.equals(other.observationId) && timestamp.equals(other.timestamp) && createdAt.equals(other.createdAt) && updatedAt.equals(other.updatedAt) && authorUserId.equals(other.authorUserId) && comment.equals(other.comment) && configId.equals(other.configId) && queueId.equals(other.queueId) && environment.equals(other.environment) && trace.equals(other.trace);
  }

  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.value, this.stringValue, this.id, this.traceId, this.name, this.source, this.observationId, this.timestamp, this.createdAt, this.updatedAt, this.authorUserId, this.comment, this.configId, this.queueId, this.environment, this.trace);
  }
  ...
  public interface UpdatedAtStage {
    TraceStage updatedAt(@NotNull OffsetDateTime updatedAt);
  }

  public interface TraceStage {
    _FinalStage trace(@NotNull GetScoresResponseTraceData trace);
  }
  ...
  public static final class Builder implements StringValueStage, IdStage, TraceIdStage, NameStage, SourceStage, TimestampStage, CreatedAtStage, UpdatedAtStage, TraceStage, _FinalStage {
    ...
    public TraceStage updatedAt(@NotNull OffsetDateTime updatedAt) {
    ...
    @java.lang.Override
    @JsonSetter("trace")
    public _FinalStage trace(@NotNull GetScoresResponseTraceData trace) {
    ...
    public GetScoresResponseDataCategorical build() {
      return new GetScoresResponseDataCategorical(value, stringValue, id, traceId, name, source, observationId, timestamp, createdAt, updatedAt, authorUserId, comment, configId, queueId, environment, trace, additionalProperties);
    }
  }
}

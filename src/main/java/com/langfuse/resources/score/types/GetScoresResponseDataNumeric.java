...
import resources.commons.types.INumericScore;
...
public final class GetScoresResponseDataNumeric implements INumericScore, IBaseScore {
  ...
  private GetScoresResponseDataNumeric(double value, String id, String traceId, String name,
      ...
      Optional<String> environment, GetScoresResponseTraceData trace,
  ...
  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.value, this.id, this.traceId, this.name, this.source, this.observationId, this.timestamp, this.createdAt, this.updatedAt, this.authorUserId, this.comment, this.configId, this.queueId, this.environment, this.trace);
  }
  ...
  public static final class Builder implements ValueStage, IdStage, TraceIdStage, NameStage, SourceStage, TimestampStage, CreatedAtStage, UpdatedAtStage, TraceStage, _FinalStage {
    ...
    public GetScoresResponseDataNumeric build() {
      return new GetScoresResponseDataNumeric(value, id, traceId, name, source, observationId, timestamp, createdAt, updatedAt, authorUserId, comment, configId, queueId, environment, trace, additionalProperties);
    }
  }
}

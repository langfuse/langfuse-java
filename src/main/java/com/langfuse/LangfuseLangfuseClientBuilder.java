...
public final class LangfuseLangfuseClientBuilder {
  ...
  public LangfuseLangfuseClientBuilder credentials(String username, String password) {
   ...
   */
  public LangfuseLangfuseClientBuilder xLangfuseSdkName(String xLangfuseSdkName) {
   ...
   */
  public LangfuseLangfuseClientBuilder xLangfuseSdkVersion(String xLangfuseSdkVersion) {
   ...
   */
  public LangfuseLangfuseClientBuilder xLangfusePublicKey(String xLangfusePublicKey) {
    this.xLangfusePublicKey = xLangfusePublicKey;
    return this;
  }

  public LangfuseLangfuseClientBuilder url(String url) {
   ...
   */
  public LangfuseLangfuseClientBuilder timeout(int timeout) {
   ...
   */
  public LangfuseLangfuseClientBuilder httpClient(OkHttpClient httpClient) {
    this.clientOptionsBuilder.httpClient(httpClient);
    return this;
  }

  public LangfuseLangfuseClient build() {
    ...
    return new LangfuseLangfuseClient(clientOptionsBuilder.build());
  }
}

...
public class AsyncLangfuseClientBuilder {
  ...
  public AsyncLangfuseClientBuilder credentials(String username, String password) {
   ...
   */
  public AsyncLangfuseClientBuilder xLangfuseSdkName(String xLangfuseSdkName) {
   ...
   */
  public AsyncLangfuseClientBuilder xLangfuseSdkVersion(String xLangfuseSdkVersion) {
   ...
   */
  public AsyncLangfuseClientBuilder xLangfusePublicKey(String xLangfusePublicKey) {
    this.xLangfusePublicKey = xLangfusePublicKey;
    return this;
  }

  public AsyncLangfuseClientBuilder url(String url) {
   ...
   */
  public AsyncLangfuseClientBuilder timeout(int timeout) {
   ...
   */
  public AsyncLangfuseClientBuilder maxRetries(int maxRetries) {
   ...
   */
  public AsyncLangfuseClientBuilder httpClient(OkHttpClient httpClient) {
   ...
   */
  public AsyncLangfuseClientBuilder addHeader(String name, String value) {
  ...
  protected void setCustomHeaders(ClientOptions.Builder builder) {
    if (this.xLangfuseSdkName != null) {
      builder.addHeader("X-Langfuse-Sdk-Name", this.xLangfuseSdkName);
    }
    if (this.xLangfuseSdkVersion != null) {
      builder.addHeader("X-Langfuse-Sdk-Version", this.xLangfuseSdkVersion);
    }
    if (this.xLangfusePublicKey != null) {
      builder.addHeader("X-Langfuse-Public-Key", this.xLangfusePublicKey);
    }
  }
  ...
  public AsyncLangfuseClient build() {
    validateConfiguration();
    return new AsyncLangfuseClient(buildClientOptions());
  }
}

...
public class RawDatasetRunItemsClient {
  ...
  public RawDatasetRunItemsClient(ClientOptions clientOptions) {
   ...
   */
  public LangfuseClientHttpResponse<DatasetRunItem> create(CreateDatasetRunItemRequest request) {
  ...
  public LangfuseClientHttpResponse<DatasetRunItem> create(CreateDatasetRunItemRequest request,
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, DatasetRunItem.class), response);
        }
        try {
     ...
     */
    public LangfuseClientHttpResponse<PaginatedDatasetRunItems> list(
    ...
    public LangfuseClientHttpResponse<PaginatedDatasetRunItems> list(
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
          ...
          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
          if (response.isSuccessful()) {
            return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PaginatedDatasetRunItems.class), response);
          }
          try {
            switch (response.code()) {
              case 400:throw new Error(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);

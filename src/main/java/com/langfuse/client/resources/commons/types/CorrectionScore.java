...
@JsonDeserialize(
    builder = CorrectionScore.Builder.class
)
public final class CorrectionScore implements ICorrectionScore, IBaseScore {
  ...
  private CorrectionScore(double value, String stringValue, String id, Optional<String> traceId,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof CorrectionScore && equalTo((CorrectionScore) other);
  }
  ...
  private boolean equalTo(CorrectionScore other) {
  ...
  public interface ValueStage {
    ...
    Builder from(CorrectionScore other);
  }
  ...
  public static final class Builder implements ValueStage, StringValueStage, IdStage, NameStage, SourceStage, TimestampStage, CreatedAtStage, UpdatedAtStage, MetadataStage, EnvironmentStage, _FinalStage {
    ...
    @java.lang.Override
    public Builder from(CorrectionScore other) {
    ...
    @java.lang.Override
    public CorrectionScore build() {
      return new CorrectionScore(value, stringValue, id, traceId, sessionId, observationId, datasetRunId, name, source, timestamp, createdAt, updatedAt, authorUserId, comment, metadata, configId, queueId, environment, additionalProperties);
    }

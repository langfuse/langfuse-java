...
public final class BaseScore implements IBaseScore {
  ...
  private BaseScore(String id, String traceId, String name, ScoreSource source,
  ...
  @java.lang.Override
  public int hashCode() {
    return Objects.hash(this.id, this.traceId, this.name, this.source, this.observationId, this.timestamp, this.createdAt, this.updatedAt, this.authorUserId, this.comment, this.configId, this.queueId, this.environment);
  }
  ...
  public static final class Builder implements IdStage, TraceIdStage, NameStage, SourceStage, TimestampStage, CreatedAtStage, UpdatedAtStage, _FinalStage {
    ...
    public BaseScore build() {
      return new BaseScore(id, traceId, name, source, observationId, timestamp, createdAt, updatedAt, authorUserId, comment, configId, queueId, environment, additionalProperties);
    }
  }
}

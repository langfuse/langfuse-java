...
public class RawModelsClient {
   ...
   * Create a model
   */
  public LangfuseClientHttpResponse<Model> create(CreateModelRequest request) {
  ...
  public LangfuseClientHttpResponse<Model> create(CreateModelRequest request,
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Model.class), response);
        }
        try {
     ...
     * Get all models
     */
    public LangfuseClientHttpResponse<PaginatedModels> list() {
     ...
     * Get all models
     */
    public LangfuseClientHttpResponse<PaginatedModels> list(RequestOptions requestOptions) {
     ...
     * Get all models
     */
    public LangfuseClientHttpResponse<PaginatedModels> list(GetModelsRequest request) {
    ...
    public LangfuseClientHttpResponse<PaginatedModels> list(GetModelsRequest request,
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
          ...
          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
          if (response.isSuccessful()) {
            return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PaginatedModels.class), response);
          }
          try {
            switch (response.code()) {
              case 400:throw new Error(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
       ...
       * Get a model
       */
      public LangfuseClientHttpResponse<Model> get(String id) {
        return get(id,null);
      }
       ...
       * Get a model
       */
      public LangfuseClientHttpResponse<Model> get(String id, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
          .addPathSegments("api/public")
         ...
         */
        public LangfuseClientHttpResponse<Void> delete(String id) {
         ...
         * Delete a model. Cannot delete models managed by Langfuse. You can create your own definition with the same modelName to override the definition though.
         */
        public LangfuseClientHttpResponse<Void> delete(String id, RequestOptions requestOptions) {
          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
            .addPathSegments("api/public")
            .addPathSegments("models")
            .addPathSegment(id);if (requestOptions != null) {

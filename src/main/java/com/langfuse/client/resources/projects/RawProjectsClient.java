...
public class RawProjectsClient {
   ...
   */
  public LangfuseClientHttpResponse<Projects> get() {
    return get(null);
  }
   ...
   * Get Project associated with API key (requires project-scoped API key). You can use GET /api/public/organizations/projects to get all projects with an organization-scoped key.
   */
  public LangfuseClientHttpResponse<Projects> get(RequestOptions requestOptions) {
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Projects.class), response);
        }
        try {
     ...
     */
    public LangfuseClientHttpResponse<Project> create(CreateProjectRequest request) {
    ...
    public LangfuseClientHttpResponse<Project> create(CreateProjectRequest request,
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
          ...
          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
          if (response.isSuccessful()) {
            return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Project.class), response);
          }
          try {
            switch (response.code()) {
              case 400:throw new Error(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
       ...
       */
      public LangfuseClientHttpResponse<Project> update(String projectId,
      ...
      public LangfuseClientHttpResponse<Project> update(String projectId,
         ...
         */
        public LangfuseClientHttpResponse<ProjectDeletionResponse> delete(String projectId) {
        ...
        public LangfuseClientHttpResponse<ProjectDeletionResponse> delete(String projectId,
          ...
          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
            ...
            try (Response response = client.newCall(okhttpRequest).execute()) {
              ...
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ProjectDeletionResponse.class), response);
              }
              try {
                switch (response.code()) {
                  case 400:throw new Error(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
           ...
           */
          public LangfuseClientHttpResponse<ApiKeyList> getApiKeys(String projectId) {
          ...
          public LangfuseClientHttpResponse<ApiKeyList> getApiKeys(String projectId,
            ...
            HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
              ...
              try (Response response = client.newCall(okhttpRequest).execute()) {
                ...
                String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                if (response.isSuccessful()) {
                  return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ApiKeyList.class), response);
                }
                try {
                  switch (response.code()) {
                    case 400:throw new Error(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
             ...
             */
            public LangfuseClientHttpResponse<ApiKeyResponse> createApiKey(String projectId) {
            ...
            public LangfuseClientHttpResponse<ApiKeyResponse> createApiKey(String projectId,
              ...
              HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                ...
                try (Response response = client.newCall(okhttpRequest).execute()) {
                  ...
                  String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                  if (response.isSuccessful()) {
                    return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ApiKeyResponse.class), response);
                  }
                  try {
                    switch (response.code()) {
                      case 400:throw new Error(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
               ...
               */
              public LangfuseClientHttpResponse<ApiKeyDeletionResponse> deleteApiKey(
              ...
              public LangfuseClientHttpResponse<ApiKeyDeletionResponse> deleteApiKey(
                ...
                HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                  ...
                  try (Response response = client.newCall(okhttpRequest).execute()) {
                    ...
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    if (response.isSuccessful()) {
                      return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ApiKeyDeletionResponse.class), response);
                    }
                    try {
                      switch (response.code()) {
                        case 400:throw new Error(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);

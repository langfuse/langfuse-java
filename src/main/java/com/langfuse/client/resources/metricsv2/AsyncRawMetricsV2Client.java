...
public class AsyncRawMetricsV2Client {
  protected final ClientOptions clientOptions;

  public AsyncRawMetricsV2Client(ClientOptions clientOptions) {
   ...
   */
  public CompletableFuture<LangfuseClientHttpResponse<MetricsV2Response>> metrics(
      GetMetricsV2Request request) {
   ...
   */
  public CompletableFuture<LangfuseClientHttpResponse<MetricsV2Response>> metrics(
      GetMetricsV2Request request, RequestOptions requestOptions) {
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      CompletableFuture<LangfuseClientHttpResponse<MetricsV2Response>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, MetricsV2Response.class), response));
              return;
            }
            try {

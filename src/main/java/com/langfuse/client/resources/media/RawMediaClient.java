...
public class RawMediaClient {
   ...
   * Get a media record
   */
  public LangfuseClientHttpResponse<GetMediaResponse> get(String mediaId) {
  ...
  public LangfuseClientHttpResponse<GetMediaResponse> get(String mediaId,
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetMediaResponse.class), response);
        }
        try {
     ...
     */
    public LangfuseClientHttpResponse<Void> patch(String mediaId, PatchMediaBody request) {
    ...
    public LangfuseClientHttpResponse<Void> patch(String mediaId, PatchMediaBody request,
       ...
       */
      public LangfuseClientHttpResponse<GetMediaUploadUrlResponse> getUploadUrl(
      ...
      public LangfuseClientHttpResponse<GetMediaUploadUrlResponse> getUploadUrl(
        ...
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
          ...
          try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            if (response.isSuccessful()) {
              return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetMediaUploadUrlResponse.class), response);
            }
            try {
              switch (response.code()) {
                case 400:throw new Error(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);

...
public class RawHealthClient {
   ...
   */
  public LangfuseClientHttpResponse<HealthResponse> health() {
    return health(null);
  }
   ...
   * Check health of API and database
   */
  public LangfuseClientHttpResponse<HealthResponse> health(RequestOptions requestOptions) {
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, HealthResponse.class), response);
        }
        try {

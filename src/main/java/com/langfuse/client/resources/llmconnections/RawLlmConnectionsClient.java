...
public class RawLlmConnectionsClient {
  protected final ClientOptions clientOptions;

  public RawLlmConnectionsClient(ClientOptions clientOptions) {
   ...
   */
  public LangfuseClientHttpResponse<PaginatedLlmConnections> list() {
   ...
   * Get all LLM connections in a project
   */
  public LangfuseClientHttpResponse<PaginatedLlmConnections> list(RequestOptions requestOptions) {
    return list(GetLlmConnectionsRequest.builder().build(),requestOptions);
  }
   ...
   */
  public LangfuseClientHttpResponse<PaginatedLlmConnections> list(
      GetLlmConnectionsRequest request) {
   ...
   * Get all LLM connections in a project
   */
  public LangfuseClientHttpResponse<PaginatedLlmConnections> list(GetLlmConnectionsRequest request,
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PaginatedLlmConnections.class), response);
        }
        try {
     ...
     */
    public LangfuseClientHttpResponse<LlmConnection> upsert(UpsertLlmConnectionRequest request) {
    ...
    public LangfuseClientHttpResponse<LlmConnection> upsert(UpsertLlmConnectionRequest request,
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        .addPathSegments("api/public")
        .addPathSegments("llm-connections");if (requestOptions != null) {
          requestOptions.getQueryParameters().forEach((_key, _value) -> {
            httpUrl.addQueryParameter(_key, _value);
          } );
        }
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
          ...
          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
          if (response.isSuccessful()) {
            return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, LlmConnection.class), response);
          }
          try {
            switch (response.code()) {
              case 400:throw new Error(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);

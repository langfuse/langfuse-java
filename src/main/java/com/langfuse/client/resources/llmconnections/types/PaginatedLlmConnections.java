...
@JsonDeserialize(
    builder = PaginatedLlmConnections.Builder.class
)
public final class PaginatedLlmConnections {
  private final List<LlmConnection> data;

  private final MetaResponse meta;

  private final Map<String, Object> additionalProperties;

  private PaginatedLlmConnections(List<LlmConnection> data, MetaResponse meta,
  ...
  @JsonProperty("data")
  public List<LlmConnection> getData() {
    return data;
  }
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof PaginatedLlmConnections && equalTo((PaginatedLlmConnections) other);
  }
  ...
  private boolean equalTo(PaginatedLlmConnections other) {
  ...
  public interface MetaStage {
    ...
    Builder from(PaginatedLlmConnections other);
  }
  ...
  public interface _FinalStage {
    ...
    _FinalStage addAllData(List<LlmConnection> data);
  }
  ...
  public static final class Builder implements MetaStage, _FinalStage {
    ...
    private List<LlmConnection> data = new ArrayList<>();
    ...
    @java.lang.Override
    public Builder from(PaginatedLlmConnections other) {
      data(other.getData());
      meta(other.getMeta());
      return this;
    }
    ...
    @java.lang.Override
    public _FinalStage addData(LlmConnection data) {
      this.data.add(data);
      return this;
    }

...
public class RawOpentelemetryClient {
   ...
   * </ul>
   */
  public LangfuseClientHttpResponse<OtelTraceResponse> exportTraces(OtelTraceRequest request) {
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, OtelTraceResponse.class), response);
        }
        try {

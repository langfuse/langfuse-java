...
public class AsyncRawMediaClient {
   ...
   * Get a media record
   */
  public CompletableFuture<LangfuseClientHttpResponse<GetMediaResponse>> get(String mediaId) {
  ...
  public CompletableFuture<LangfuseClientHttpResponse<GetMediaResponse>> get(String mediaId,
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      .addPathSegment(mediaId);if (requestOptions != null) {
      ...
      CompletableFuture<LangfuseClientHttpResponse<GetMediaResponse>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetMediaResponse.class), response));
              return;
            }
            try {
     ...
     */
    public CompletableFuture<LangfuseClientHttpResponse<Void>> patch(String mediaId,
        PatchMediaBody request) {
      return patch(mediaId,request,null);
    }
     ...
     */
    public CompletableFuture<LangfuseClientHttpResponse<Void>> patch(String mediaId,
        PatchMediaBody request, RequestOptions requestOptions) {
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        .addPathSegments("api/public")
        .addPathSegments("media")
        .addPathSegment(mediaId);if (requestOptions != null) {
       ...
       */
      public CompletableFuture<LangfuseClientHttpResponse<GetMediaUploadUrlResponse>> getUploadUrl(
       ...
       */
      public CompletableFuture<LangfuseClientHttpResponse<GetMediaUploadUrlResponse>> getUploadUrl(
          GetMediaUploadUrlRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
          .addPathSegments("api/public")
          .addPathSegments("media");if (requestOptions != null) {
            requestOptions.getQueryParameters().forEach((_key, _value) -> {
              httpUrl.addQueryParameter(_key, _value);
            } );
          }
          ...
          CompletableFuture<LangfuseClientHttpResponse<GetMediaUploadUrlResponse>> future = new CompletableFuture<>();
          client.newCall(okhttpRequest).enqueue(new Callback() {
            @Override
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
              try (ResponseBody responseBody = response.body()) {
                String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                if (response.isSuccessful()) {
                  future.complete(new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetMediaUploadUrlResponse.class), response));
                  return;
                }
                try {
                  switch (response.code()) {

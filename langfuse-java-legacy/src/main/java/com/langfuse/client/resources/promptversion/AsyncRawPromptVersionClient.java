...
public class AsyncRawPromptVersionClient {
  protected final ClientOptions clientOptions;

  public AsyncRawPromptVersionClient(ClientOptions clientOptions) {
   ...
   */
  public CompletableFuture<LangfuseClientHttpResponse<Prompt>> update(String name, int version,

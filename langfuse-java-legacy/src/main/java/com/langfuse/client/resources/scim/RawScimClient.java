...
public class RawScimClient {
  protected final ClientOptions clientOptions;

  public RawScimClient(ClientOptions clientOptions) {
   ...
   */
  public LangfuseClientHttpResponse<ServiceProviderConfig> getServiceProviderConfig() {
  ...
  public LangfuseClientHttpResponse<ServiceProviderConfig> getServiceProviderConfig(
    ...
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      try (Response response = client.newCall(okhttpRequest).execute()) {
        ...
        if (response.isSuccessful()) {
          return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ServiceProviderConfig.class), response);
        }
        try {
     ...
     */
    public LangfuseClientHttpResponse<ResourceTypesResponse> getResourceTypes() {
    ...
    public LangfuseClientHttpResponse<ResourceTypesResponse> getResourceTypes(
      ...
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        ...
        try (Response response = client.newCall(okhttpRequest).execute()) {
          ...
          String responseBodyString = responseBody != null ? responseBody.string() : "{}";
          if (response.isSuccessful()) {
            return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ResourceTypesResponse.class), response);
          }
          try {
            switch (response.code()) {
              case 400:throw new Error(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
       ...
       */
      public LangfuseClientHttpResponse<SchemasResponse> getSchemas() {
       ...
       * Get SCIM Schemas (requires organization-scoped API key)
       */
      public LangfuseClientHttpResponse<SchemasResponse> getSchemas(RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
          .addPathSegments("api/public/scim")
          ...
          try (Response response = client.newCall(okhttpRequest).execute()) {
            ...
            String responseBodyString = responseBody != null ? responseBody.string() : "{}";
            if (response.isSuccessful()) {
              return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, SchemasResponse.class), response);
            }
            try {
              switch (response.code()) {
                case 400:throw new Error(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
         ...
         */
        public LangfuseClientHttpResponse<ScimUsersListResponse> listUsers() {
         ...
         * List users in the organization (requires organization-scoped API key)
         */
        public LangfuseClientHttpResponse<ScimUsersListResponse> listUsers(ListUsersRequest request,
            RequestOptions requestOptions) {
          HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
            .addPathSegments("api/public/scim")
            ...
            try (Response response = client.newCall(okhttpRequest).execute()) {
              ...
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ScimUsersListResponse.class), response);
              }
              try {
                switch (response.code()) {
                  case 400:throw new Error(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
           ...
           */
          public LangfuseClientHttpResponse<ScimUser> createUser(CreateUserRequest request) {
          ...
          public LangfuseClientHttpResponse<ScimUser> createUser(CreateUserRequest request,
            ...
            HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
              ...
              try (Response response = client.newCall(okhttpRequest).execute()) {
                ...
                String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                if (response.isSuccessful()) {
                  return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, ScimUser.class), response);
                }
                try {
                  switch (response.code()) {
                    case 400:throw new Error(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);
             ...
             */
            public LangfuseClientHttpResponse<ScimUser> getUser(String userId) {
            ...
            public LangfuseClientHttpResponse<ScimUser> getUser(String userId,
               ...
               */
              public LangfuseClientHttpResponse<EmptyResponse> deleteUser(String userId) {
              ...
              public LangfuseClientHttpResponse<EmptyResponse> deleteUser(String userId,
                ...
                HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
                  ...
                  try (Response response = client.newCall(okhttpRequest).execute()) {
                    ...
                    String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                    if (response.isSuccessful()) {
                      return new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, EmptyResponse.class), response);
                    }
                    try {
                      switch (response.code()) {
                        case 400:throw new Error(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Object.class), response);

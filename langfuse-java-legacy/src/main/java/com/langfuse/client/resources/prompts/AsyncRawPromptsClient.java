...
public class AsyncRawPromptsClient {
   ...
   * Get a prompt
   */
  public CompletableFuture<LangfuseClientHttpResponse<Prompt>> get(String promptName) {
   ...
   */
  public CompletableFuture<LangfuseClientHttpResponse<Prompt>> get(String promptName,
      GetPromptRequest request, RequestOptions requestOptions) {
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Prompt.class), response));
              return;
            }
            try {
     ...
     */
    public CompletableFuture<LangfuseClientHttpResponse<PromptMetaListResponse>> list() {
     ...
     */
    public CompletableFuture<LangfuseClientHttpResponse<PromptMetaListResponse>> list(
        ListPromptsMetaRequest request) {
     ...
     */
    public CompletableFuture<LangfuseClientHttpResponse<PromptMetaListResponse>> list(
        ListPromptsMetaRequest request, RequestOptions requestOptions) {
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        .addPathSegments("api/public/v2")
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
          ...
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PromptMetaListResponse.class), response));
                return;
              }
              try {
                switch (response.code()) {
       ...
       */
      public CompletableFuture<LangfuseClientHttpResponse<Prompt>> create(
       ...
       */
      public CompletableFuture<LangfuseClientHttpResponse<Prompt>> create(
          CreatePromptRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
          .addPathSegments("api/public/v2")
         ...
         */
        public CompletableFuture<LangfuseClientHttpResponse<Void>> delete(String promptName) {

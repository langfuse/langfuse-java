...
public class AsyncRawOpentelemetryClient {
   ...
   * </ul>
   */
  public CompletableFuture<LangfuseClientHttpResponse<OtelTraceResponse>> exportTraces(
      OtelTraceRequest request) {
    return exportTraces(request,null);
  }
   ...
   */
  public CompletableFuture<LangfuseClientHttpResponse<OtelTraceResponse>> exportTraces(
      OtelTraceRequest request, RequestOptions requestOptions) {
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      .addPathSegments("api/public")
      .addPathSegments("otel/v1/traces");if (requestOptions != null) {
      ...
      CompletableFuture<LangfuseClientHttpResponse<OtelTraceResponse>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, OtelTraceResponse.class), response));
              return;
            }
            try {

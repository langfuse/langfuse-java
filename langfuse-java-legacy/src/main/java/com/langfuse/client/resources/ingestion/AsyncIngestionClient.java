...
public class AsyncIngestionClient {
  protected final ClientOptions clientOptions;

  private final AsyncRawIngestionClient rawClient;

  public AsyncIngestionClient(ClientOptions clientOptions) {
    this.clientOptions = clientOptions;
    this.rawClient = new AsyncRawIngestionClient(clientOptions);
  }

  /**
   * Get responses with HTTP metadata like headers
   */
  public AsyncRawIngestionClient withRawResponse() {
   ...
   * </ul>
   */
  public CompletableFuture<IngestionResponse> batch(IngestionRequest request) {
    return this.rawClient.batch(request).thenApply(response -> response.body());
  }
  ...
  public CompletableFuture<IngestionResponse> batch(IngestionRequest request,
    ...
    return this.rawClient.batch(request, requestOptions).thenApply(response -> response.body());
  }
}

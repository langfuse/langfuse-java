...
public class AsyncRawLlmConnectionsClient {
  protected final ClientOptions clientOptions;

  public AsyncRawLlmConnectionsClient(ClientOptions clientOptions) {
   ...
   */
  public CompletableFuture<LangfuseClientHttpResponse<PaginatedLlmConnections>> list() {
   ...
   */
  public CompletableFuture<LangfuseClientHttpResponse<PaginatedLlmConnections>> list(
      GetLlmConnectionsRequest request, RequestOptions requestOptions) {
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, PaginatedLlmConnections.class), response));
              return;
            }
            try {
     ...
     */
    public CompletableFuture<LangfuseClientHttpResponse<LlmConnection>> upsert(
     ...
     */
    public CompletableFuture<LangfuseClientHttpResponse<LlmConnection>> upsert(
        UpsertLlmConnectionRequest request, RequestOptions requestOptions) {
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        .addPathSegments("api/public")
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
          ...
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, LlmConnection.class), response));
                return;
              }
              try {
                switch (response.code()) {

...
public class AsyncRawScoreClient {
  protected final ClientOptions clientOptions;

  public AsyncRawScoreClient(ClientOptions clientOptions) {
   ...
   */
  public CompletableFuture<LangfuseClientHttpResponse<CreateScoreResponse>> create(
   ...
   */
  public CompletableFuture<LangfuseClientHttpResponse<CreateScoreResponse>> create(
      CreateScoreRequest request, RequestOptions requestOptions) {
    HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
      ...
      CompletableFuture<LangfuseClientHttpResponse<CreateScoreResponse>> future = new CompletableFuture<>();
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateScoreResponse.class), response));
              return;
            }
            try {
     ...
     */
    public CompletableFuture<LangfuseClientHttpResponse<Void>> delete(String scoreId) {

...
public class AsyncRawCommentsClient {
   ...
   */
  public CompletableFuture<LangfuseClientHttpResponse<CreateCommentResponse>> create(
   ...
   */
  public CompletableFuture<LangfuseClientHttpResponse<CreateCommentResponse>> create(
      CreateCommentRequest request, RequestOptions requestOptions) {
        ...
        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
          try (ResponseBody responseBody = response.body()) {
            ...
            if (response.isSuccessful()) {
              future.complete(new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, CreateCommentResponse.class), response));
              return;
            }
            try {
     ...
     * Get all comments
     */
    public CompletableFuture<LangfuseClientHttpResponse<GetCommentsResponse>> get() {
     ...
     */
    public CompletableFuture<LangfuseClientHttpResponse<GetCommentsResponse>> get(
        GetCommentsRequest request, RequestOptions requestOptions) {
      HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl()).newBuilder()
        .addPathSegments("api/public")
        ...
        client.newCall(okhttpRequest).enqueue(new Callback() {
          ...
          public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
            try (ResponseBody responseBody = response.body()) {
              String responseBodyString = responseBody != null ? responseBody.string() : "{}";
              if (response.isSuccessful()) {
                future.complete(new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, GetCommentsResponse.class), response));
                return;
              }
              try {
                switch (response.code()) {
       ...
       * Get a comment by id
       */
      public CompletableFuture<LangfuseClientHttpResponse<Comment>> getById(String commentId) {
          ...
          client.newCall(okhttpRequest).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
              try (ResponseBody responseBody = response.body()) {
                String responseBodyString = responseBody != null ? responseBody.string() : "{}";
                if (response.isSuccessful()) {
                  future.complete(new LangfuseClientHttpResponse<>(ObjectMappers.JSON_MAPPER.readValue(responseBodyString, Comment.class), response));
                  return;
                }
                try {
                  switch (response.code()) {
